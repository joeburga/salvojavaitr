...
$('#login-form').on('submit', function (event) {
    ...
    if (submitButton == "login") {
        $.post("/api/login",
            //cambie a email y password igual al http.formLogin() en
            // SalvoApplication / configure()
            { email: $("#username").val(),
        ...
        $.post("/api/players",
            //Agregue campo userName: $("#username").val(), porque en SalvoController espera un
            //campo userName, luego verificar el html si agrego un campo para userName.
            { email: $("#username").val(),
...
function updateView() {
        ...
        if (data.player == "Guest") {
            ...
            //cambie data.player.name a data.player.email para Current player: j.bauer@ctu.gov
            //que es del campo email del SalvoController
